...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // If no validation errors, proceed with saving to database
    if (empty($errors)) {
        $pdo = getDbConnection();
        ...
        if ($pdo) {
            try {
                ...
                if ($success) {
                    ...
                    $errors['general'] = "Failed to save assignment";
                }
...
<head>
    ...
    <title>Add Assignment - Chki</title>
    ...
    <div class="app-container">
        ...
        <nav class="main-nav">
            ...
            <div class="nav-section right">
                <a href="add-assignment.php" class="btn add-btn active" aria-current="page" aria-label="Add assignment">
        ...
        <main class="content-area">
            <div class="form-container">
                ...
                <form id="assignmentForm" class="assignment-form" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <select id="courseSelect" name="courseSelect"
                                ...
                                aria-required="true">
                            <option value="" disabled <?php echo empty($course) ? 'selected' : ''; ?>>Select a course</option>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn save-btn">Save Assignment</button>
                    </div>
                </form>
            </div>
        </main>
